...
import { Button, Caveat, Label, Panel, ScreenHeader, Slider } from "@/components/ui/primitives";
  ...
  return (
    <div className="fadein">
      <ScreenHeader
        ...
        desc="Drag the plane to where the measurement should stop, then confirm."
        onBack={onBack}
      />
